...
export const cases: CaseStudy[] = [
  {
    ...
    teaser: 'Ein Weltmarktführer, dessen Erfolg die eigene Ordnung unantastbar gemacht hatte — bis er neu entschied, wer Ideen über Bereichsgrenzen verfolgen darf und wem sie zugerechnet werden.',
  ...
  },
  {
    ...
    teaser: 'Jeder Fall ein Standardfall, jede Antwort zentral geregelt — bis Kunden andere Fragen stellten. Die Führung verteilte neu, wer entscheidet: Teams, die ihre Kunden kennen.',
  ...
  },
  {
    ...
    teaser: 'Wie 15 eigenständige IT-Unternehmen aushandelten, was eine gemeinsame Organisation verbindlich regelt — und was lokal bleibt.',
